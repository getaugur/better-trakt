...
export async function getShowSummary_Full(client: AxiosInstance, showId: string) {
...
export async function getMovieSummary_Full(client: AxiosInstance, movieId: string) {
